...
const PUSH_SUPERSET_A = 'push-a';
const PULL_SUPERSET_A = 'pull-a';
const CORE_SUPERSET_A = 'core-a';
...
export const templates: WorkoutTemplate[] = [
  {
    ...
    exercises: [
      ...
      { exerciseId: 'incline-db-press',         sets: 3, repRange: [8, 10],  isSuperset: true, supersetGroupId: PUSH_SUPERSET_A },
      { exerciseId: 'cable-triceps-pushdown',   sets: 3, repRange: [10, 12], isSuperset: true, supersetGroupId: PUSH_SUPERSET_A },
  ...
  },
  {
    ...
    exercises: [
      ...
      { exerciseId: 'face-pull',              sets: 3, repRange: [12, 15], isSuperset: true, supersetGroupId: PULL_SUPERSET_A },
      { exerciseId: 'barbell-curl',           sets: 3, repRange: [8, 10],  isSuperset: true, supersetGroupId: PULL_SUPERSET_A },
  ...
  },
  {
    ...
    exercises: [
      ...
      { exerciseId: 'weighted-sit-up',    sets: 3, repRange: [8, 12],  isSuperset: true, supersetGroupId: CORE_SUPERSET_A },
      { exerciseId: 'pallof-press',       sets: 3, repRange: [10, 12], isSuperset: true, supersetGroupId: CORE_SUPERSET_A },
  ...
  },
  {
    ...
    exercises: [
      ...
      { exerciseId: 'glute-bridge',       sets: 2, repRange: [12, 15], isSuperset: false },
    ],
  },
  {
    id: 'back',
    ...
    exercises: [
      ...
      { exerciseId: 'straight-arm-pulldown', sets: 3, repRange: [12, 15], isSuperset: false },
      { exerciseId: 'barbell-shrug',        sets: 3, repRange: [12, 15], isSuperset: false },
    ],
  },
];
